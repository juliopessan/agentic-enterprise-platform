...
from app.agents.hr.hr_manager import hr_manager_agent
...
def run_talent_ops(task_name: str, payload: dict):
    ...
    crew = Crew(
        agents=[hr_manager_agent, talent_acquisition_agent], 
        tasks=[t],
        verbose=True,
        planning=True
    )
...
def run_people_lifecycle(task_name: str, payload: dict):
    ...
    crew = Crew(
        agents=[hr_manager_agent, onboarding_agent], 
        tasks=[t],
        verbose=True,
        planning=True
    )
...
def run_hr_compliance(task_name: str, payload: dict):
    ...
    crew = Crew(
        agents=[hr_manager_agent, hr_compliance_agent], 
        tasks=[t],
        verbose=True,
        planning=True
    )
